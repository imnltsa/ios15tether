...
- A tweak that causes SpringBoard to crash will put your device in a respring loop. Hold the Volume Up button while the device is respringing to enter safe mode.
